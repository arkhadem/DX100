...
if [ "$1" = "FUNC" ]; then
    ...
    g++ -std=c++11 test_dummy_instruction.cpp -o test_dummy_instruction.o -g3 -DFUNC -DTILE_SIZE=16384 -DNUM_CORES=4 -O3
elif [ "$1" = "GEM5" ]; then
    ...
    g++ -std=c++11 $GEM5_HOME/util/m5/build/x86/abi/x86/m5op.S test_dummy_instruction.cpp $GEM5_LIB $GEM5_INCLUDE -g3 -DGEM5 -DTILE_SIZE=16384 -DNUM_CORES=4 -O3 -o test_dummy_instruction.o
else
