...
class SimpleO3Core : public Clocked<SimpleO3Core> {
    ...
    public:
        Trace(std::string file_path_str, int bubble_count);
...
public:
    SimpleO3Core(int id, int ipc, int depth, std::string trace_path, ITranslation *translation, SimpleO3LLC *llc, int bubble_count);
